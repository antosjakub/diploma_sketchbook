...
but it has since found a bodar random of applications, including in
numeral method for solving partial differential equations.
...
Issues:
the number of grid points and component grids still rises

in larger dimensions, more levels are needed to achieve a given accuracy
