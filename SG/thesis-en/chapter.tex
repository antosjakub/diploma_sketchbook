...
To improve this, we formulate the following optimization problem: we seek a finite a collection of subspaces $W_l$ that maximizes the approximation benefit for a corresponding prescribed cost.
