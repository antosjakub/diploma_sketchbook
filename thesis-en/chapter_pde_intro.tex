...
In this thesis, we consider second order linear parabolic partial differential equations.
...
\begin{align*}
\partial_t u + \mathcal{L}\,u = 0\quad &\text{in } Q_T \\
u(x,t) = 0\quad &\text{on } \Omega \times (0,T) \\
u(x,0) = g(x)\quad &\text{on } \Omega
\end{align*}

Where
\begin{itemize}
\item $u: Q_T \to \mathbb{R}$
...
In particular, we wil be working with the follwing two variants:
...
%\section{Application: evolution of a molecule with a LJ potential}
%
