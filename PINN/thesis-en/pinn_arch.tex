...
\node[right=0.6cm of ad] (r_pde) {$\mathcal{L}_{pde} = ||\partial_t u_\theta + L\,u_\theta - f||^2_{(0,T)\times\Omega}$};
\node[above right=0.05cm and 0.6cm of ad] (r_ic) {$\mathcal{L}_{ic} = ||u_\theta - u_{ic}||^2_{\Omega}$};
\node[above right=0.5cm and 0.6cm of ad] (r_bc) {$\mathcal{L}_{bc} = ||u_\theta - u_{bc}||^2_{(0,T)\times\partial\Omega}$};
