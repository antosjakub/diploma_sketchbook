...
However, here, we do not have any huge labeled dataset to iterate over.
In PINNs, we usually proceed in a way that blends together both the minibatch and the fullbarch approaches.
...
Instead of \emph{epochs}, we talk of \emph{steps}.
