...
CURRENT_DIR = "gridsearch__2026-07-08--12-03-06__lamda_seed"
TERM = "pde"
...
def create_pivot_table(records, err_type):
    ...
    col_keys = sorted({record["seed"] for record in records.values()})
    ...
    for record in records.values():
        matrix[row_index[record["lambda_ic"]], col_index[record["seed"]]] = record[err_type]
