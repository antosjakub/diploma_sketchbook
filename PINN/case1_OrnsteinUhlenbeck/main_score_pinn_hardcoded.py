...
## LL ODE
    ...
    model_s.load_state_dict(torch.load(model_s_path, weights_only=True, map_location=device))
    model_s.eval()
...
loss_name, l2_name = run_utils.save_run(dir_name, model, losses, l2_errs, args, head_fn="hardcoded_ic")
